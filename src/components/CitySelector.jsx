...
//   if(selectedCountry) {
//     axios
//     .get(`https://crio-location-selector.onrender.com/country={countryName}/states`)
//     .then((response) => {
...
//     axios
//     .get(`https://crio-location-selector.onrender.com/country={countryName}/state={stateName}/cities`)
//     .then((response) => {
